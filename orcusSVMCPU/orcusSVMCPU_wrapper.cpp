#include "orcusSVMCPU_wrapper.h"
#include "OrcusSvm.h"
#include "../utils.h"

int OrcusSvmCPUData::Load(char *filename, SVM_FILE_TYPE file_type, SVM_DATA_TYPE data_type)
{
...
int OrcusSvmCPUModel::Train(SvmData *data, struct svm_params * params, struct svm_trainingInfo *trainingInfo)
{
    this->data = data;
    this->params = params;
    ...
    try
    {
        ...
        OrcusSvmCPUTrain(alphas, &rho, is_sparse,
...
int OrcusSvmCPUModel::StoreModel(char *model_file_name, SVM_MODEL_FILE_TYPE type)
{
